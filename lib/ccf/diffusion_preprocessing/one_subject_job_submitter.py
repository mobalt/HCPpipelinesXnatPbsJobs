...
class OneSubjectJobSubmitter(one_subject_job_submitter.OneSubjectJobSubmitter):
	...
	def create_process_data_job_script(self):
		...
		xnat_pbs_setup_singularity_process = 'singularity exec --nv -B ' + self._get_xnat_pbs_setup_script_archive_root() + ',' + self._get_xnat_pbs_setup_script_singularity_bind_path() \
